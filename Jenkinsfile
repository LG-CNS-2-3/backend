        ...
        stage('Build and Deploy Services') {
            parallel {
                ...
                stage('backend-map pipeline') {
                    ...
                    environment {
                        EC2_HOST = "ubuntu@10.0.0.20" //  backend-map 서버 IP
                    }
                    stages {
                        stage('map: Build'){
                            steps{
